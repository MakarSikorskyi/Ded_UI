...
guildText:SetPoint("CENTER", guildFrame, "BOTTOMRIGHT", -3, 7)
if cfg.core.position ~= "BOTTOM" then
...
friendText:SetPoint("CENTER", friendFrame, "BOTTOMRIGHT", -3, 7)
if cfg.core.position ~= "BOTTOM" then
...
friendFrame:SetScript("OnEnter", function()
	...
	GameTooltip:AddLine(cfg.TooltipTitleText("Друзья"))
	GameTooltip:AddLine(" ")
	--------------------------
...
eventframe:SetScript("OnEvent", function(self,event, ...)
	...
	local totalFriend, onlineFriend = GetNumFriends()
	friendText:SetText(onlineFriend)
	
	if onlineFriend == 0 then
		friendText:SetText("")
	else
