...
cfg.armor = {
	show = true,			-- USES THIS MODULE
	minArmor = 50,			-- WHEN THE ANVIL GOES FROM INACTIVE TO ACTIVE
	maxArmor = 90,			-- AT WHAT % IT WILL SHOW ARMORTEXT INSTEAD OF ILVL
}
...
coreTexture:SetTexture(unpack(cfg.color.barcolor))
